...
usage() {
  this=$1
  cat <<EOF
$this: download go binaries for h4ux/idotenv

Usage: $this [-b] bindir [-d] [tag]
  -b sets bindir or installation directory, Defaults to ./bin
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/h4ux/idotenv/releases
...
get_binaries() {
  case "$PLATFORM" in
    darwin/amd64) BINARIES="idotenv" ;;
    darwin/arm64) BINARIES="idotenv" ;;
    darwin/386) BINARIES="idotenv" ;;
    linux/386) BINARIES="idotenv" ;;
    linux/amd) BINARIES="idotenv" ;;
    linux/amd64) BINARIES="idotenv" ;;
    linux/arm) BINARIES="idotenv" ;;
    linux/arm64) BINARIES="idotenv" ;;
    windows/amd64) BINARIES="idotenv" ;;
    windows/amd64) BINARIES="idotenv" ;;
    *)
